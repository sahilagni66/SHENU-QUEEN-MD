...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'FELIX KA BOT 🧚' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'LEE FELIX' : process.env.OWNER_NAME,
  ownernumber: process.env.OWNER_NUMBER === undefined ? '919517641203' : process.env.OWNER_NUMBER,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'FELIX 𝗠𝗗' : process.env.PACK_INFO.split(";")[1],	
  ...
  caption :process.env.CAPTION || "  \t🧚 *Ruk Ja Bhai*",
